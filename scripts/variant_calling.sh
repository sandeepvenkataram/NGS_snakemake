...
gatk HaplotypeCaller -I ${snakemake_input[bam]} -O ${snakemake_params[prefix]}.vcf -R ${snakemake_params[ref_fasta]} -bamout ${snakemake_output[bamout]}  &> ${snakemake_log[0]}_haplotype_caller.log
